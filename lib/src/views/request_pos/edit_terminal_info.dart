...
class EditTerminalInfo extends StatefulWidget {
  const EditTerminalInfo({super.key});

  @override
  State<EditTerminalInfo> createState() => _EditTerminalInfoState();
}

class _EditTerminalInfoState extends State<EditTerminalInfo> {
  @override
