...
class RavenPaySuccessPage extends StatefulWidget {
  const RavenPaySuccessPage({super.key});

  @override
  State<RavenPaySuccessPage> createState() => _RavenPaySuccessPageState();
}

class _RavenPaySuccessPageState extends State<RavenPaySuccessPage> {
  int currentIndex = 0;
  @override
